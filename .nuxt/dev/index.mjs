import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/vue/index.mjs';
import { GraphQLClient } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/graphql-request/build/esm/index.js';
import { basename, isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/ipx/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/node_modules/@unhead/shared/dist/index.mjs';
...
const _wQsqPOXAif = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Nálunk a technológia találkozik a természettel. Új és használt mezőgazdasági gépek gazdag kínálatával segítjük Önt abban, hogy a legjobb teljesítményt hozza ki földjeiből."},{"name":"format-detection","content":"telephone=no"},{"hid":"robots","name":"robots","content":"index, follow"},{"http-equiv":"Content-Security-Policy","content":"\n            default-src 'self' https: data:;\n            img-src 'self' https: http: data:;\n            font-src 'self' https: data:;\n            style-src 'self' https: 'unsafe-inline';\n            script-src 'self' https: 'unsafe-inline' 'unsafe-eval';\n          "}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"canonical","href":"https://www.bakonybutor.info"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"hu"}};
...
const config$1 = {"default":{"token":{"type":"Bearer","name":"Authorization"},"proxyCookies":true,"tokenStorage":{"mode":"cookie","cookieOptions":{"maxAge":604800,"secure":false},"name":"gql:default"},"preferGETQueries":false,"host":"https://api.koreagro.hu/graphql","corsOptions":{"mode":"cors","credentials":"include"}}};
const clients = {};
const GqlNitro = { clients, config: config$1 };

const _zAnuJTFDjL = defineNitroPlugin(() => {
...
const _inlineRuntimeConfig = {
    ...
    "graphql-client": {
      "clients": {
        "default": {
          ...
          "host": "https://api.koreagro.hu/graphql",
          "corsOptions": {
            "mode": "cors",
            "credentials": "include"
          }
      ...
      "configLocales": [
        {
          ...
          "name": "Magyar HU",
          "files": [
            "/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/woonuxt_base/app/locales/hu-HU.json"
          ]
        }
      ],
      "locales": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/woonuxt_base/public"
      ]
    },
    "http": {
      "domains": [
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _fK5070 = defineCachedEventHandler(async (event) => {
...
const _lvJonW = lazyEventHandler(() => {
...
const _lazy_hVe2hC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_hVe2hC, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _fK5070, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _lvJonW, lazy: false, middleware: false, method: undefined },
  { route: '/products/**', handler: _lazy_hVe2hC, lazy: true, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_hVe2hC, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hVe2hC, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/KoreAgroWoonuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
