...
const module = defineNuxtModule({
  ...
  async setup(_, nuxt) {
    ...
    try {
      ...
      console.error(error);
      console.log(
        "\x1B[1;35mError fetching woonuxt settings. Make sure you have the latest version woonuxt-settings plugin installed on WordPress. https://github.com/scottyzen/woonuxt-settings"
      );
    }
  }
});
